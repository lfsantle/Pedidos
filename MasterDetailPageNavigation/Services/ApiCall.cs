...
namespace MasterDetailPageNavigation.Services
{
	public class ApiCall
	{
		static readonly string ApiUrl = "http://www.lfsant.com.br/PedidosTOL/{0}";


		public async Task<T> GetResponse<T>(string param) where T : class
		{
			...
			var response = await client.GetAsync(string.Format(ApiUrl, param));
